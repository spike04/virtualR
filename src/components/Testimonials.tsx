    ...
    <div className="text-center pb-8 mt-20">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-white sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
          <figure className="rounded-2xl bg-white/5 shadow-lg ring-1 ring-gray-900/5 sm:col-span-2 xl:col-start-2 xl:row-end-1">
                ...
                >
                  {column.map((testimonial) => (
                    <figure
                      ...
                      className="rounded-2xl bg-white/5 text-white p-6 shadow-lg ring-1 ring-gray-900/5"
                    >
                      <blockquote>
